...
contract KleeMine is Ownable {
    ...
    struct PoolInfo {
        address TokenA; // Eth Address
        address TokenB; // YM1 or YM2 Address
        uint256 totalStake; // Total amount of
    }
    struct UserInfo {
    ...
    // Select which pool to add asset into, and amount of ETH and YM1 / ETH and YM2
